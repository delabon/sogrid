...
/**
 * One & Others Style 1 Block
 */
class Sogrid_OOS1 extends Sogrid_Block{
    ...
    protected function renderStyle( $attributes ){
        ...
        return "
            ...
            #{$uid}.sogrid--oos1 .sogrid__others,
            #{$uid}.sogrid--oos1 .sogrid__others .sogrid__entry,        
            #{$uid}.sogrid--oos1 .sogrid__one{
                border-color: {$borderColor};
            }

            #{$uid}.sogrid--oos1 .sogrid__entry__title a,
            #{$uid}.sogrid--oos1 .sogrid__entry__title a:focus,
            #{$uid}.sogrid--oos1 .sogrid__entry__title a:hover,
            #{$uid}.sogrid--oos1 .sogrid__entry__title a:visited{
                color: {$titleColor};
            }
    
            #{$uid}.sogrid--oos1 .sogrid__entry__meta{
                color: {$dateColor};
            }
    
            #{$uid}.sogrid--oos1 .sogrid__entry__meta .sogrid__entry__author,
            #{$uid}.sogrid--oos1 .sogrid__entry__meta .sogrid__entry__author:hover,
            #{$uid}.sogrid--oos1 .sogrid__entry__meta .sogrid__entry__author:focus,
            #{$uid}.sogrid--oos1 .sogrid__entry__meta .sogrid__entry__author:visited{
                color: {$authorColor};
            }

            #{$uid}.sogrid--oos1 .sogrid__entry__categories a,
            #{$uid}.sogrid--oos1 .sogrid__entry__categories a:hover,
            #{$uid}.sogrid--oos1 .sogrid__entry__categories a:focus,
            #{$uid}.sogrid--oos1 .sogrid__entry__categories a:visited{
                color: {$categoryColor};
            }
    
            #{$uid}.sogrid--oos1 .sogrid__entry__excerpt{
                color: {$excerptColor};
            }
    
            #{$uid}.sogrid--oos1 .sogrid__entry__readmore,
            #{$uid}.sogrid--oos1 .sogrid__entry__readmore:hover,
            #{$uid}.sogrid--oos1 .sogrid__entry__readmore:focus,
            #{$uid}.sogrid--oos1 .sogrid__entry__readmore:visited{
                color: {$readmoreColor};
                background-color: {$readmoreBGColor};
            }   

            #{$uid}.sogrid--oos1 .sogrid__pagination{
                border-color: {$borderColor};
            }
            
            #{$uid}.sogrid--oos1 .sogrid__pagination span{
                color: {$paginationColor};
                background-color: {$paginationBgColor};
            }
    
            #{$uid}.sogrid--oos1 .sogrid__pagination span.__active{
