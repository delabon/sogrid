...
class Sogrid_Bordered extends Sogrid_Block{
    ...
    protected function renderStyle( $attributes ){
        ...
        return "
            ...
            #{$uid}.sogrid--bordered .sogrid__entry__title a:hover,
            #{$uid}.sogrid--bordered .sogrid__entry__title a:focus,
            #{$uid}.sogrid--bordered .sogrid__entry__title a:visited{
                color: {$titleColor};
            }
            ...
            #{$uid}.sogrid--bordered .sogrid__entry__meta .sogrid__entry__author:hover,
            #{$uid}.sogrid--bordered .sogrid__entry__meta .sogrid__entry__author:focus,
            #{$uid}.sogrid--bordered .sogrid__entry__meta .sogrid__entry__author:visited{
                color: {$authorColor};
            }

            #{$uid}.sogrid--bordered .sogrid__entry__categories a,
            #{$uid}.sogrid--bordered .sogrid__entry__categories a:hover,
            #{$uid}.sogrid--bordered .sogrid__entry__categories a:focus,
            #{$uid}.sogrid--bordered .sogrid__entry__categories a:visited{
                color: $categoryColor;
            }
            ...
            #{$uid}.sogrid--bordered .sogrid__entry__readmore:hover,
            #{$uid}.sogrid--bordered .sogrid__entry__readmore:focus,
            #{$uid}.sogrid--bordered .sogrid__entry__readmore:visited{
                color: $readmoreColor;
